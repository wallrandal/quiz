    ...
    <div class="container">
        <div class="row">
            <div class="col-xs-12 col-sm-8 col-sm-offset-2 col-md-6 col-md-offset-3">
                <h1>Animations</h1>
                <hr>
                <select class="form-control" name="" v-model="alertAnimation" id="">
...
<script>
    ...
    import DandgerAlert from "./components/DangerAlert";
